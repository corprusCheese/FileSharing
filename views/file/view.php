...
<?php foreach($fileComments as $comment):?>
    ...
    <?php }?>
        ...
        <?php endif; ?>
        <?php if (is_object($userModel) && $userModel->username == $fileUploaderName): ?>
        <div class="comment-buttons">
            <a href=<?=Url::to(['comment/delete','id'=>$comment->id])//"../comment/delete?id=".$comment->id ?>
